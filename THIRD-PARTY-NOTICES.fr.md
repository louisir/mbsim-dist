...
Le code applicatif propre à MBSim et sa documentation sont distribués sous la MIT License. Voir [LICENSE](LICENSE).

La MIT License s'applique au code propre de MBSim. Elle ne relicencie pas en MIT les bibliothèques d'exécution tierces livrées avec le paquet portable.
...
- La MIT License de MBSim ne supprime ni n'affaiblit les exigences de licence de Qt.
...
1. Conservez la MIT License de MBSim avec le paquet.
2. Conservez les avis de tiers et les textes de licence avec le paquet.
3. Consultez la page de licence Qt actuelle pour les modules exacts inclus dans votre build.
4. Si vous distribuez un paquet construit avec Qt open source et des modules Qt GPL-only, assurez-vous que la distribution respecte GPLv3, ou utilisez une licence commerciale Qt.
